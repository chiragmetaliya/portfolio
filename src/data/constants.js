export const Bio = {
  ...
  description:
    "I am a dynamic and versatile software developer with over 5+ years of hands-on experience in C#, .NET, and ASP.NET Core. Passionate about building scalable and secure enterprise solutions, I consistently strive to write clean, maintainable code that solves real-world business problems. My calm demeanor and analytical thinking help me thrive in Agile, team-oriented environments. Whether maintaining legacy systems or developing modern APIs, I’m always eager to contribute meaningful, high-impact solutions that align with long-term product goals and architectural standards.",
  ...
  facebook: "https://www.facebook.com/chiraagmetaliya/",
  skype:"https://join.skype.com/invite/leuPIwnseNWx",
};
...
export const skills = [
  {
    ...
    skills: [
      ...
      {
        name: "ASP.NET",
        image: "https://cdn.prod.website-files.com/6047a9e35e5dc54ac86ddd90/63064f1fedf422395124660e_e7d03466.png",
      },
      {
        name: ".NET Core",
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Blazor",
        image:
          "https://damienbod.com/wp-content/uploads/2024/01/brandblazor_nohalo_1000x.png",
      },
      {
        name: "Bootstrap",
        image:
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Google Cloud",
        image:
          "https://e7.pngegg.com/pngimages/834/472/png-clipart-google-cloud-icon-google-cloud-platform-cloud-computing-amazon-web-services-virtual-private-cloud-cloud-computing-text-trademark-thumbnail.png",
      },
      {
        name: "Microsoft IIS",
        image:
          "https://deepnetsecurity.com/wp-content/uploads/MFA-for-IIS-Websites.png",
      },
      {
        name: "Docker",
        image:
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Swagger",
        image:
          "https://cdn.worldvectorlogo.com/logos/swaggerhub-1.svg",
      },
      {
        name: "Git",
        image:
...
export const experiences = [
  ...
  
  {
    ...
    role: "Prompt Engineer - Software Development",
    company: "Outlier.ai",
    date: "Mar 2024 - Jul 2025",
    desc: "🚀 Evaluated AI-generated C#, .NET Core, Python, JavaScript, and TypeScript code, to ensure efficiency, functionality, and accuracy.\n\n 🚀 Created Data Science prompts to ensure accurate model analysis and visualization using Python libraries like pandas.\n\n 🚀 Ensured best practices in code, debugging, and wrote clear, concise summaries explaining scientific concepts.\n\n 🚀 Crafted data-focused prompts to train AI models for accurate predictions and insightful data analysis.\n\n 🚀 Designed prompts for machine learning workflows, enhancing model capabilities in data processing and evaluation.",
    skills: [
      "C#", 
      ".NET Core", 
      "NodeJS", 
  ...
  },
  {
    ...
    role: "FullStack Software Developer (.NET & AWS)",
    company: "i2techs",
    date: "May 2022 - Jan 2023",
    desc: "🚀 Collaborated with an agile team to develop enterprise-grade web applications using C#, ASP.NET MVC, & .NET Core.\n\n 🚀 Developed and consumed RESTful APIs to support integrations with external systems, ensuring secure data exchange.\n\n 🚀 Implemented service-oriented architecture (SOA) principles to ensure modular and loosely coupled system components.\n\n 🚀 Improved performance and API response times up to 70% by refactoring core services and applying best practices.\n\n 🚀 Built and optimized WCF and Web API services for seamless integration with external systems, improving reliability.\n\n 🚀 Investigated complex issues and optimized MS SQL queries to extract data 25% faster from a large database.\n\n 🚀 Initiated DevOps workflow using Amazon AWS, Docker and GIT that led to 85% increase in deployment activities.\n\n 🚀 Integrated third-party tools, APIs & Webhooks to enable seamless data integration of applications in various domains.\n\n 🚀 Contributed towards increasing application efficiency by 27% with active participation in agile development processes.",
    skills: [
      "C#", 
      "ASP.NET MVC",
      ".NET Core", 
  ...
  },
  {
    ...
    desc: "🚀  Developed and maintained seamless user experience by leveraging react.js features and styled components.\n\n 🚀  Applied Test-Driven Development (TDD) in .NET Core to guarantee bug-free code for RESTful APIs for client projects.\n\n 🚀 Resolved data access issues like account histories or transactions using Entity Framework in a banking application.\n\n 🚀 Engineered secure, scalable cloud infrastructure on Azure, optimizing for high performance and efficient resource use.\n\n 🚀 Implemented CI/CD pipelines on Microsoft Azure for automated testing, deployment, and release management.\n\n 🚀 Worked with various automation tools, cloud monitoring tools and scalable infrastructure across AWS services.\n\n 🚀 Mentored juniors with code reviews and pair programming sessions maintaining high coding standards.",
    skills: [
      "C#",
      "ASP.NET MVC", 
      ".NET Core", 
  ...
  },
  {
    ...
    desc: "🚀  Helped offshore clients by developing and optimizing RESTful APIs using ASP.Net, .NET Core, enhancing scalability.\n\n 🚀 Collaborated with client teams to troubleshoot, debug and fix issues in legacy components of existing applications.\n\n 🚀 Demonstrated a problem-solving mindset and detail-oriented approach to develop and improve application features.",
    skills: [
      "C#", 
      ".NET Core", 
      "NodeJS", 
  ...
  },
  {
    ...
    desc: "🚀  Analyzed legacy project internals and created a presentation for future improvements.\n\n 🚀  Built a real estate client website with C#, ASP.NET, and SQL Server, enhancing lead conversion efficiency by 20%.\n\n 🚀  Performed unit testing and debugging with Chrome Developer Tools and Postman to ensure quality outputs.",
    skills: [
      "C#", 
      "ASP.NET", 
      "ADO.Net", 
...
export const education = [
  {
    id: 0,
    img: "https://firebasestorage.googleapis.com/v0/b/chiragmetaliya-df2e9.appspot.com/o/Uwin.jpg?alt=media&token=09218112-799e-4b7a-940c-a37a4e88b943",
    school: "University of Windsor, ON, Canada",
    date: "May 2023 - Aug 2024",
    grade: "8.0 GPA",
    desc: "I've completed graduation from University of Windsor, ON, Canada. I have completed 4 terms and have a GPA of 8.0. I have taken courses in Advanced Software Engineering, Advanced Data Structures, Advanced System Programming, Advanced Database Management, Internet Applications & Distributed Systems, Network and Security, among others. I also participated in various academic events like Demo Day and contributed as a volunteer in many activities while pursuing my graduation from UOW.",
    degree: "Masters in Applied Computing -  Computer Science",
  },
  {
    id: 1,
    img: "https://firebasestorage.googleapis.com/v0/b/chiragmetaliya-df2e9.appspot.com/o/gtu.png?alt=media&token=ff15c176-aabd-41df-94d1-893bf4336bb2",
    school: "V.V.P Engineering College under Gujarat Technological University, Gujarat, India",
    date: "Aug 2014 - June 2017",
    grade: "9.24 CGPA",
    desc: "I completed my Bachelor’s degree in Information Technology from Gujarat Technological University, where I gained a strong foundation in various key areas of IT. My coursework included Java Programming, Database Management Systems, Data Structures and Algorithms, Operating Systems, and Networking and Security, among others. During my time at GTU, I developed a solid understanding of both theoretical concepts and practical applications, preparing me for diverse challenges in the IT field.",
    degree: "Bachelors in Information Technology",
  },
  {
    id: 2,
    img: "https://firebasestorage.googleapis.com/v0/b/chiragmetaliya-df2e9.appspot.com/o/nirma.png?alt=media&token=bcb6e667-cb6b-4b89-acb6-97651b7da2dc",
    school: "Institute of Diploma Studies, under Nirma University",
    date: "Apr 2011 - July 2014",
    grade: "8.84 CGPA",
    desc: "I completed a Diploma in Information Technology from Nirma University, where I acquired hands-on experience and knowledge in several core areas of IT. My studies included C and C++ Programming, Java Programming, Web Development, Database Management Systems, and Android Application Development. Additionally, I explored foundational concepts in Networking and Software Engineering, which provided me with a well-rounded understanding of both software development and network systems.",
...
export const certifications = [
  {
    ...
    description:
      "Certified as an AWS Cloud Practitioner, demonstrating a strong foundational understanding of AWS Cloud concepts, core services, security, architecture principles, pricing models, and support plans. The certification covers key areas such as IAM, compute and storage services, billing and cost management, cloud deployment models, and the AWS shared responsibility model. It also includes practical insights into global infrastructure, best practices for building in the cloud, and identifying appropriate AWS services for common use cases.",
    image:
      "https://firebasestorage.googleapis.com/v0/b/chiragmetaliya-df2e9.appspot.com/o/AWS%20Certificate.PNG?alt=media&token=b1f24408-7ba3-49ad-b4a9-21783aa66c32",
    tags: [
      "AWS",
      "EC2",
      "S3",
    ...
    certificateLink: "https://cp.certmetrics.com/amazon/en/public/verify/credential/6019008dc48940a9bf06893206cdd45a"
  },
  {
    id: 1,
